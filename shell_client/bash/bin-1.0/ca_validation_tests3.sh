...
VALUE="300"
(( RND= RANDOM % 100 ))
echo ' { "hostname": "'$SOURCE'", "ci_ipaddress": "'10.1.100.$OCTET'", "ci_name": "'$SOURCE'", "source": "'$SOURCE'", "object": "QOS_HTTPGTW_CAVALID_COUNTER", "target": "'$TARGET'", "value": '$VALUE' } ' | $CLIENT $CLIENT_VERBOSE -p - qos/data
echo ' { "hostname": "'$SOURCE'", "ci_ipaddress": "'10.1.100.$OCTET'", "ci_name": "'$SOURCE'", "source": "'$SOURCE'", "object": "QOS_HTTPGTW_CAVALID_GAUGE", "target": "'$TARGET'", "value": '$VALUE' } ' | $CLIENT $CLIENT_VERBOSE -p - qos/data
if [ "$RND" -gt 40 ]
then
	echo ' { '$TNT2DATA' "ci_name": "'$TARGET'", "message": "Alarm Message", "severity": "warn" } ' | $CLIENT $CLIENT_VERBOSE -p - alarm/create
else
	echo ' { '$TNT2DATA' "ci_name": "'$TARGET'", "message": "Alarm Message", "severity": "minor" } ' | $CLIENT $CLIENT_VERBOSE -p - alarm/create
fi
...
(( RND= RANDOM % 100 ))
(( IDLE= 100 - RND ))
echo ' { '$TNT2DATA' "object": "QOS_HTTPGTW_CAVALID_CPU", "target": "'cpu total'", "value": '$RND' } ' | $CLIENT $CLIENT_VERBOSE -p - qos/data
echo ' { '$TNT2DATA' "object": "QOS_HTTPGTW_CAVALID_CPU", "target": "'cpu idle'", "value": '$IDLE' } ' | $CLIENT $CLIENT_VERBOSE -p - qos/data
if [ "$RND" -gt 40 ]
then
...
(( RND= RANDOM % 100 ))
(( IDLE= 100 - RND ))
echo ' { '$TNT2DATA' "ci_name": "'$SOURCE'", "source": "'$SOURCE'", "object": "QOS_HTTPGTW_CAVALID_CPU", "target": "'cpu total'", "value": '$RND' } ' | $CLIENT $CLIENT_VERBOSE -p - qos/data
echo ' { '$TNT2DATA' "ci_name": "'$SOURCE'", "source": "'$SOURCE'", "object": "QOS_HTTPGTW_CAVALID_CPU", "target": "'cpu idle'", "value": '$IDLE' } ' | $CLIENT $CLIENT_VERBOSE -p - qos/data
